                ...
                <div className="card w-full h-[50vh]  bigTablet:h-[70vh]  bg-base-100 image-full rounded-none text-start">
                    ...
                    <div className=" card-body ">
                        ...
                        <div className="card-actions flex justify-center mt-10">
                            ...
                            <Link to={`${link}`}>
                                <button>
                                    <span className="relative inline-flex items-center px-24 py-4 overflow-hidden text-lg font-medium text-black border-[1.1px] bg-white hover:text-white group hover:bg-transparent">
