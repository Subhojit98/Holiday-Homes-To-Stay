...
export const MotiveData = [
    {id: 1,
    head: "OWN A PIECE OF AMēA",
    title: "Rethink your vacation",
    body_text_1:"Enjoy the benefits of a glamorous villa with boutique apartments in some of the most scenic holiday destinations in the world, starting from USD 25’000 per ownership stake.",
    body_text_2: "Our vision goes further: We already want the future guests onboard during the development and make them part of the entire value chain. Discover an unparalleled project and join a community of like-minded and inspired souls.",
    btn_1_Text: "Become an investor",
    btn_2_Text: "Investment details",
    image: motiveImg_1,
    imagePosition: 'float-right',
    imagePostionOnFlex: 'flex-row-reverse'},

    {id: 2,
    head: "Hear what others say",
    ...
    btn_1_Text: "Investment opportunities",
